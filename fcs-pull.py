            ...
            if file_name.endswith('.tar.gz'):
                ...
                with zipfile.ZipFile(file_name, 'r') as zip_file:
                    ...
                    for file_info in zip_file.filelist:
                        if file_info.filename.endswith('/fcs') or file_info.filename.endswith('fcs.exe') or file_info.filename == 'fcs':
                            # Extract to our bin path
...
def main():
    ...
    fcs_binary_path = puller.pull_fcs(target_version=version, bin_path=bin_path)
